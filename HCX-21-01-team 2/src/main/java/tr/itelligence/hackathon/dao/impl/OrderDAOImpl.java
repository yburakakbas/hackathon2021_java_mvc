...
import tr.itelligence.hackathon.entity.Order;
import tr.itelligence.hackathon.entity.OrderDetail;
...
public class OrderDAOImpl implements OrderDAO {
    ...
    public List<OrderDetailInfo> getAllByProductId(String productCode) {
        ...
        try {
            ...
            Criteria criteria = session.createCriteria(OrderDetail.class, "orderDetail");
            criteria.createAlias("orderDetail.product", "product");
