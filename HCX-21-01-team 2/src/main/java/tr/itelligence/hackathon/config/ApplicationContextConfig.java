...
import tr.itelligence.hackathon.dao.impl.*;

@Configuration
@ComponentScan("tr.itelligence.hackathon.*")
...
public class ApplicationContextConfig {
    ...
    public SessionFactory getSessionFactory(DataSource dataSource) throws Exception {
        ...
        factoryBean.setPackagesToScan(new String[]{"tr.itelligence.hackathon.entity"});
