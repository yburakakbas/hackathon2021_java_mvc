...
import tr.itelligence.hackathon.model.CustomerInfo;
...
import tr.itelligence.hackathon.validator.CustomerInfoValidator;
...
public class MainController {
    ...
    public String listProductHandler(Model model, //
                                     ...
                                     @RequestParam(value = "subcategory", defaultValue = "") Long subcategoryId) {
        final int maxResult = 5;
        final int maxNavigationPage = 10;

        PaginationResult<ProductInfo> result = productDAO.queryProducts(page, //
                maxResult, maxNavigationPage, likeName, code, categoryId, subcategoryId);

        List<Category> categoryList = this.categoryDAO.findAll();
        List<Subcategory> subcategoryList = this.subcategoryDAO.findAll();
